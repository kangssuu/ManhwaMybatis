 ...
 */
@WebServlet("/item/new.do")
public class ItemNewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ItemNewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!itemList.isEmpty()) {
			...
			RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/item/new.jsp");
